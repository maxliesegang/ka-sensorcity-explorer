export default {
  ...
  history: "Verlauf",
  historyIntro: "Entwicklung dieser Messgröße im Zeitverlauf erkunden.",
  ...
  historyControls: {
    aria: "Zeitsteuerung des Verlaufs",
    range: "Zeitraum",
    ranges: {
      day: "24 Stunden",
      week: "7 Tage",
    ...
    selectedWindow: "Gewähltes Intervall",
    showing: "{{visible}} von {{total}} archivierten Messwerten",
    earlier: "Früher",
    later: "Später",
    latest: "Aktuellstes",
    download: "CSV herunterladen",
    noReadings: "Keine Messwerte in diesem Intervall. Versuchen Sie ein früheres oder späteres Intervall.",
  },
  historySummary: {
    heading: "Auf einen Blick",
    intro: "Zusammenfassung für {{range}}",
    latest: "Letzter Messwert",
    change: "Veränderung",
    changeDetail: "Vom ersten bis zum letzten Wert im Intervall",
    average: "Durchschnitt",
    readingCount: "aus {{count}} Messwerten",
    range: "Messwertspanne",
    lowToHigh: "Vom niedrigsten bis zum höchsten Wert",
  },
  historyDeepDive: {
    heading: "Muster und Statistik",
    intro: "Trend, Streuung und Durchschnitt nach Tagesstunde",
  },
  profile: {
